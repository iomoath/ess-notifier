...
A simple security notable scanner for Splunk ESS SIEM (Enterprise Security). The purpose of this tool is to send Slack & email notifications whenever a new security notable event is triggered on Splunk ESS.
